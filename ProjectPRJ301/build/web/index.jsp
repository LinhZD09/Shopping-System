<%-- 
    Document   : index
    Created on : Mar 4, 2024, 5:21:55 PM
    Author     : MSI
--%>
...
<html>
    ...
    <head>
        ...
        <title>Master Chef LinhZD</title>
                        ...
                        <div class="row tm-header-inner">
                            <div class="col-md-6 col-12">
                                ...
                                <div class="tm-site-text-box">
                                    <h1 class="tm-site-title">Master Cheff LinhZD</h1>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="placeholder-2">
                            <div class="parallax-window-2" data-parallax="scroll" data-image-src="img/cuahang.jpg"></div>		
                        </div>
                    </div>
                </div>
            </div>
